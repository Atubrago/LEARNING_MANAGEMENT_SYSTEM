...
class User extends Authenticatable
{
    ...
    public function instructorCourseInstructors()
    {
        return $this->hasMany(CourseInstructor::class, 'instructor_id', 'id');
    }

    public function authorNotices()
    {
        return $this->hasMany(Notice::class, 'author_id', 'id');
    }

    public function studentCourseStudents()
    {
