<div class="content">
    @can('course_instructor_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.course-instructors.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.courseInstructor.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-instructorCourseInstructors">
                            <thead>
                                <tr>
                                    <th width="10">
...
@can('course_instructor_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.course-instructors.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-instructorCourseInstructors:not(.ajaxTable)').DataTable({ buttons: dtButtons })
